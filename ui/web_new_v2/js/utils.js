...
export const FALLBACK_GRADIENTS = [
    'linear-gradient(135deg, #f43f5e 0%, #fb7185 100%)', // Blossom / Rose
    'linear-gradient(135deg, #fb923c 0%, #f43f5e 100%)', // Sunset Amber to Rose
    'linear-gradient(135deg, #a855f7 0%, #ec4899 100%)', // Violet Magenta
    'linear-gradient(135deg, #06b6d4 0%, #3b82f6 100%)', // Cyan Ocean
    'linear-gradient(135deg, #10b981 0%, #06b6d4 100%)', // Emerald Teal
    'linear-gradient(135deg, #8b5cf6 0%, #6366f1 100%)', // Purple Indigo
    'linear-gradient(135deg, #f59e0b 0%, #ef4444 100%)', // Amber Flame
    'linear-gradient(135deg, #1e1b4b 0%, #f43f5e 100%)'  // Velvet Rose
];

export function getCoverFallbackGradient(title) {
    if (!title || typeof title !== 'string') return FALLBACK_GRADIENTS[0];
    let hash = 0;
...
export const SVG_NOTE_FALLBACK = `
<svg class="fallback-note-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:48%;height:48%;opacity:0.7;position:relative;z-index:2;">
