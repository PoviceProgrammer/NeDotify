(function() {
    const ICONS = {
        'folder-plus': '<path d="M12 5v14"></path><path d="M5 12h14"></path><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path>',
        ...
        'play': '<polygon points="6 4 18 12 6 20 6 4" fill="currentColor" stroke="none"></polygon>',
        'pause': '<rect x="6" y="4" width="4" height="16" rx="1" fill="currentColor" stroke="none"></rect><rect x="14" y="4" width="4" height="16" rx="1" fill="currentColor" stroke="none"></rect>',
        'skip-back': '<polygon points="19 20 9 12 19 4 19 20" fill="currentColor" stroke="none"></polygon><line x1="5" y1="19" x2="5" y2="5" stroke="currentColor" stroke-width="2"></line>',
        'skip-forward': '<polygon points="5 4 15 12 5 20 5 4" fill="currentColor" stroke="none"></polygon><line x1="19" y1="5" x2="19" y2="19" stroke="currentColor" stroke-width="2"></line>',
        ...
        'shuffle': '<path d="M2 18h1.4c1.3 0 2.5-.6 3.3-1.7l6.6-8.6c.8-1.1 2-1.7 3.3-1.7H22"></path><path d="m18 2 4 4-4 4"></path><path d="M2 6h1.9c1.5 0 2.9.9 3.6 2.2"></path><path d="M22 18h-5.9c-1.3 0-2.5-.6-3.3-1.7l-.5-.7"></path><path d="m18 14 4 4-4 4"></path>',
        ...
        'picture-in-picture-2': '<path d="M21 9V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h4"></path><rect width="10" height="7" x="11" y="13" rx="1"></rect>',
        'arrow-left': '<path d="m12 19-7-7 7-7"></path><path d="M19 12H5"></path>',
        'chevron-down': '<path d="m6 9 6 6 6-6"></path>',
        'download': '<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line>',
        'info': '<circle cx="12" cy="12" r="10"></circle><path d="M12 16v-4"></path><path d="M12 8h.01"></path>',
        'key': '<path d="m15.5 7.5 2.3 2.3a1 1 0 0 0 1.4 0l2.1-2.1a1 1 0 0 0 0-1.4L19 4.1a1 1 0 0 0-1.4 0l-2.1 2.1a1 1 0 0 0 0 1.3Z"></path><path d="m13.5 9.5-9 9a2.12 2.12 0 0 0 3 3l9-9"></path>',
        ...
        'download-cloud': '<path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"></path><path d="12 12v9"></path><path d="m8 17 4 4 4-4"></path>',
        ...
        'folder-open': '<path d="m6 14 1.45-2.9A2 2 0 0 1 9.24 10H20a2 2 0 0 1 1.94 2.5l-1.55 6a2 2 0 0 1-1.94 1.5H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H18a2 2 0 0 1 2 2v2"></path>',
        ...
        'infinity': '<path d="M12 12c-2-2.67-4-4-6-4a4 4 0 1 0 0 8c2 0 4-1.33 6-4Zm0 0c2 2.67 4 4 6 4a4 4 0 1 0 0-8c-2 0-4 1.33-6 4Z"></path>',
        ...
        'thumbs-down': '<path d="M17 14V2a2 2 0 0 0-2-2H6.83a2 2 0 0 0-1.66.9L1 7.2v6.8a2 2 0 0 0 2 2h7.82l-1.04 4.54a2 2 0 0 0 1.95 2.46c.86 0 1.63-.52 1.91-1.33L17 14z"></path>',
        'share-2': '<circle cx="18" cy="5" r="3"></circle><circle cx="6" cy="12" r="3"></circle><circle cx="18" cy="19" r="3"></circle><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"></line><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"></line>',
        'pin': '<line x1="12" y1="17" x2="12" y2="22"></line><path d="M5 17h14v-1.76a2 2 0 0 0-1.11-1.79l-1.78-.9A2 2 0 0 1 15 10.76V6h1a1 1 0 0 0 0-2H8a1 1 0 0 0 0 2h1v4.76a2 2 0 0 1-1.11 1.79l-1.78.9A2 2 0 0 0 5 15.24Z"></path>',
    ...
    function renderElement(el, nameAttr) {
        const name = el.getAttribute(nameAttr || 'data-lucide');
        if (!name) return;
        const inner = ICONS[name] || `<circle cx="12" cy="12" r="8"></circle>`;
        const style = el.getAttribute('style') || '';
        const width = el.style.width || '16px';
        const height = el.style.height || '16px';
    ...
    function createIcons(options) {
        ...
        elements.forEach(el => renderElement(el, nameAttr));
    }
