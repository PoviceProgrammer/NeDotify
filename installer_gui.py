...
def register_uninstaller(dest_dir, exe_path, uninstaller_path):
    try:
        ...
        winreg.SetValueEx(key, "DisplayName", 0, winreg.REG_SZ, "NeDotify v1.5.0")
        ...
        winreg.SetValueEx(key, "DisplayVersion", 0, winreg.REG_SZ, "1.5.0")
        winreg.CloseKey(key)
    except Exception as e:
...
class InstallerApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Установка NeDotify v1.5.0")
        ...
        # Title
        title = tk.Label(root, text="Установка NeDotify v1.5.0", font=("Segoe UI", 16, "bold"))
    ...
    def install(self):
        ...
        try:
            ...
            messagebox.showinfo("Успех", f"NeDotify v1.5.0 успешно установлен в:\n{dest_dir}")
            self.root.destroy()
