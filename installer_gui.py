...
def register_uninstaller(dest_dir, exe_path, uninstaller_path):
    try:
        ...
        winreg.SetValueEx(key, "DisplayName", 0, winreg.REG_SZ, "NeDotify beta5")
        ...
        winreg.SetValueEx(key, "DisplayVersion", 0, winreg.REG_SZ, "5.0 Beta")
        winreg.CloseKey(key)
    except Exception as e:
...
class InstallerApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Установка NeDotify beta5")
        ...
        # Title
        title = tk.Label(root, text="Установка NeDotify (beta5)", font=("Segoe UI", 16, "bold"))
    ...
    def install(self):
        ...
        try:
            ...
            messagebox.showinfo("Успех", f"NeDotify beta5 успешно установлен в:\n{dest_dir}")
            self.root.destroy()
